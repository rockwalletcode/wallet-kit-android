...
public class TransferDetailsActivity extends AppCompatActivity implements DefaultSystemListener {
    ...
    private static final String EXTRA_WALLET_NAME = "com.blockset.walletkit.demo,TransferDetailsActivity.EXTRA_WALLET_NAME";
    private static final String EXTRA_TXN_ID = "com.blockset.walletkit.demo,TransferDetailsActivity.EXTRA_TXN_ID";
    ...
    protected void onResume() {
        ...
        DemoApplication.getDispatchingSystemListener().addWalletManagerListener(walletManager, this);
        DemoApplication.getDispatchingSystemListener().addTransferListener(transfer, this);
        loadTransfer();
    }
    ...
    protected void onPause() {
        ...
        DemoApplication.getDispatchingSystemListener().removeTransferListener(transfer, this);
        DemoApplication.getDispatchingSystemListener().removeWalletManagerListener(walletManager, this);
    }
