...
import com.blockset.walletkit.PaymentProtocolPaymentAck;
...
public class TransferCreatePaymentActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_WALLET_NAME = "com.blockset.walletkit.demo,TransferCreatePaymentActivity.EXTRA_WALLET_NAME";
    private static final String EXTRA_PROTOCOL = "com.blockset.walletkit.demo,TransferCreatePaymentActivity.EXTRA_PROTOCOL";
    ...
    private void continuePayment(PaymentProtocolRequest request, TransferFeeBasis feeBasis) {
        ...
        if (!request.signTransfer(transfer, DemoApplication.getPaperKey())) {
