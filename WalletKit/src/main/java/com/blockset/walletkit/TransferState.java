...
public final class TransferState {
    ...
    private static final TransferState AUTHENTICATOR_STATE = new TransferState(Type.AUTHENTICATOR, null, null);
    private static final TransferState EMAIL_STATE = new TransferState(Type.EMAIL, null, null);
    ...
    public static TransferState AUTHENTICATOR() {
