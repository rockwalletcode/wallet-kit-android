...
public interface Wallet {
     ...
     * 'zero out' the wallet
     *
     * In cases where `balance < fee` then {@link com.blockset.walletkit.errors.LimitEstimationInsufficientFundsError}
     * is returned.  This can occur for an ERC20 transfer where the ETH wallet's balance is not enough to pay the fee.
     * That is, the {@link com.blockset.walletkit.errors.LimitEstimationInsufficientFundsError} check respects the
    ...
    */
     ...
     *
     * In cases where `balance < amount + fee` then {@link com.blockset.walletkit.errors.LimitEstimationInsufficientFundsError}
     * is returned.  The {@link com.blockset.walletkit.errors.LimitEstimationInsufficientFundsError} check respects the
