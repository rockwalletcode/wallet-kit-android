...
public final class WKNativeLibraryIndirect {
    ...
    public static void wkClientAnnounceTransactionsReceiveAddressSync(Pointer cwm, Pointer callbackState, int success, WKClientTransactionBundle[] bundles, SizeT bundlesCount) {
        INSTANCE.wkClientAnnounceTransactionsReceiveAddressSync(cwm, callbackState, success,
                (0 == bundlesCount.intValue() ? null : bundles),
                bundlesCount);
    }
    ...
    public interface LibraryInterface extends Library {
        ...
        void wkClientAnnounceTransactionsReceiveAddressSync(Pointer cwm, Pointer callbackState, int success, WKClientTransactionBundle[] bundles, SizeT bundlesCount);
