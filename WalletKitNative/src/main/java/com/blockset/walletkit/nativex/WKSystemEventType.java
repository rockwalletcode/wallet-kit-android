...
public enum WKSystemEventType {
    ...
    RECEIVE_ADDRESS_SYNC {
        @Override
        public int toCore() { return RECEIVE_ADDRESS_SYNC_VALUE; }
    };
    ...
    private static final int RECEIVE_ADDRESS_SYNC_VALUE = 10;
    ...
    public static WKSystemEventType fromCore(int nativeValue) {
        switch (nativeValue) {
            ...
            case RECEIVE_ADDRESS_SYNC_VALUE: return RECEIVE_ADDRESS_SYNC;
