...
public class WKSyncStoppedReason extends Structure {
    ...
    public WKSyncStoppedReason() {
        super();
    }

    public WKSyncStoppedReasonType type() {
        return WKSyncStoppedReasonType.fromCore(typeEnum);
    }
    ...
    public WKSyncStoppedReason(int type, u_union u) {
        super();
        this.typeEnum = type;
        this.u = u;
    }

    public WKSyncStoppedReason(Pointer peer) {
        super(peer);
    }
    ...
    public void read() {
        super.read();
        if (type() == WKSyncStoppedReasonType.POSIX)
            u.setType(u_union.posix_struct.class);
        u.read();
    }

    public Optional<String> getMessage() {
        Pointer ptr = WKNativeLibraryDirect.wkSyncStoppedReasonGetMessage(this);
        try {
