...
public class WKWallet extends PointerType {
    ...
    public @Nullable String getAddressFromScript(@Nullable String outputScript) {
        ...
        byte[] addressBuf = new byte[64];

        WKNativeLibraryIndirect.wkWalletGetAddressFromScript(
                thisPtr,
                outputScript,
                addressBuf,
                new SizeT(64)
        ...
        return new String(addressBuf, StandardCharsets.UTF_8).replace("\u0000", "");
    }

    public Optional<WKTransfer> createTransfer(@Nullable String outputScript, WKAmount amount,
                                               WKFeeBasis estimatedFeeBasis,
                                               List<WKTransferAttribute> attributes,
                                               @Nullable String exchangeId,
                                               @Nullable String secondFactorCode,
        ...
        return Optional.fromNullable(
                WKNativeLibraryIndirect.wkWalletCreateTransferFromScript(
                        thisPtr,
                        outputScript,
                        amount.getPointer(),
                        estimatedFeeBasis.getPointer(),
