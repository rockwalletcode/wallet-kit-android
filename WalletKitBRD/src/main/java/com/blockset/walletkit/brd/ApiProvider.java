...
public final class ApiProvider implements Api.Provider {
    ...
    private static final Api.AccountProvider accountProvider = new Api.AccountProvider() {
        ...
        public String getXPubFromSerialization(byte[] serialization, String code, byte[] phrase) {
            ...
            } else if (Objects.equals(code, "bsv") || Objects.equals(code, "BSV")) {
                wkType = WKNetworkType.BSV;
            } else if (Objects.equals(code, "bch") || Objects.equals(code, "BCH")) {
                wkType = WKNetworkType.BCH;
            } else if (Objects.equals(code, "ltc") || Objects.equals(code, "LTC")) {
                wkType = WKNetworkType.LTC;
            } else if (Objects.equals(code, "doge") || Objects.equals(code, "DOGE")) {
    ...
    private static final Api.CoderProvider coderProvider = Coder::createForAlgorithm;
    ...
    private static final Api.HasherProvider hasherProvider = Hasher::createForAlgorithm;
    ...
    private static final Api.SignerProvider signerProvider = Signer::createForAlgorithm;
